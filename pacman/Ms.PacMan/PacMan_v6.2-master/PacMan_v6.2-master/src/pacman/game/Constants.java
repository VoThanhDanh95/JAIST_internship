...
public final class Constants
{
	...
	public enum MOVE 
	{
		UP 		{ public MOVE opposite(){return MOVE.DOWN;		};},	//0
		RIGHT 	{ public MOVE opposite(){return MOVE.LEFT;		};}, 	//1
		DOWN 	{ public MOVE opposite(){return MOVE.UP;		};},	//2
		LEFT 	{ public MOVE opposite(){return MOVE.RIGHT;		};}, 	//3
		NEUTRAL	{ public MOVE opposite(){return MOVE.NEUTRAL;	};};	//4
